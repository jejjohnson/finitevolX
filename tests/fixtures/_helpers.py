...
These helpers are imported by individual ``test_<operator>.py`` files in
the masks-everywhere regression suite.  See :mod:`tests.fixtures.inputs`
for the canonical input fields and :mod:`tests.fixtures._gen_golden` for
the script that produces the goldens.
"""
